                ...
                <ol class="breadcrumb">
                    <li class="nav-item ml-auto d-none d-md-flex align-items-center">
                            <button type="button" class="btn d-none d-lg-inline-block mb-1 btn-roxo-fill">
                                <i class="fa fa-plus fa-fw mr-1"></i> Nova persona
                            </button>
                        </li>
                </ol>
            </nav>
...
<div class="row">
    <div class="col-md-3 col-sm-12 mb-5">
        <ul class="menu-lateral">
            <li class="active">Todas as pautas</li>
            <li><a href="pautas.html">Pautas em rascunho</a></li>
            <li><a href="pautas.html">Pautas enviada</a></li>
        </ul>
    </div>
    <div class="col-md-9">
