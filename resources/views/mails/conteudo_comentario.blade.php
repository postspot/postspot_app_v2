        ...
        <table cellspacing="0" cellpadding="10" border="0" width="600" style="margin: 0 auto;background-color: white;border-bottom: 2px solid #84344b">
            ...
            <tr>
                <td align="center">
                    ...
                    <p style="font-size: 30px;margin: 20px 0px;">Comentário em conteúdo</p>
                </td>
            </tr>
            <tr>
                <td height="70" style="vertical-align: middle;padding: 15px 40px;">
                    Confira as informações do comentário:<br><br>
                    ...
                    <a style="background-color: #1A7D8B;color: #fff;border-radius: 2px;padding: 11px 24px;display: table;margin: 0px auto;text-decoration: none;margin-top: 45px;font-size: 16px;" href="">Ver comentário</a>
