...
class CreateEstrategiasTable extends Migration
{
    ...
    public function up()
    {
        Schema::create($this->tableName, function (Blueprint $table) {
            ...
            $table->string('objetivo_primario', 100)->nullable()->default(null);
            ...
            $table->text('concorrentes')->nullable()->default(null);
            ...
            $table->text('links_ref')->nullable()->default(null);
            $table->string('canais', 100)->nullable()->default(null);
            $table->text('acoes')->nullable()->default(null);
