...
class CreateConteudoTesteCandidatoTable extends Migration
{
    ...
    public function up()
    {
        Schema::create($this->tableName, function (Blueprint $table) {
            ...
            $table->unsignedInteger('id_teste_candidato');
            $table->unsignedInteger('id_habilidade');

            $table->index(["id_teste_candidato"], 'id_teste_candidato');

            $table->index(["id_teste_candidato"], 'conteudo_teste_candidato_id_teste_candidato_index');

            $table->index(["id_habilidade"], 'conteudo_teste_candidato_id_habilidade_index');
